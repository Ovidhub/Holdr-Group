...
class PageContentSeeder extends Seeder
{
    ...
    private function home(): array
    {
        ...
        return [
            ...
            ['page'=>$p,'key'=>'feature_cards_body','label'=>'Feature: cards body','group'=>'Features','type'=>'textarea','value'=>'Create virtual and physical cards instantly, set your own limits, and spend in the currency you choose — with total transparency and total speed.'],            ['page'=>$p,'key'=>'feature_secure_title','label'=>'Feature: security title','group'=>'Features','type'=>'text','value'=>'Innovative, Secure and Truly Digital'],
            ...
            ['page'=>$p,'key'=>'platform_body','label'=>'Platform body','group'=>'Platform','type'=>'textarea','value'=>'Exchange money across the world in real time with some of the lowest fees available, and hold and manage multiple currencies from a single, secure account.'],            ['page'=>$p,'key'=>'stats_heading','label'=>'Stats heading','group'=>'Stats','type'=>'text','value'=>'Trusted by Millions Around the World'],
    ...
    private function about(): array
    {
        ...
        return [
            ...
            ['page'=>$p,'key'=>'who_body','label'=>'Who-we-are body','group'=>'Who We Are','type'=>'textarea','value'=>'From freelancers to fast-growing companies, organisations rely on Mortil Holders to hold multiple currencies, pay teams and suppliers worldwide, and move money in real time.'],            ['page'=>$p,'key'=>'story_heading','label'=>'Story heading','group'=>'Our Story','type'=>'text','value'=>'Digital Banking, Reinvented'],
            ...
            ['page'=>$p,'key'=>'customers_body','label'=>'Customers body','group'=>'Customers','type'=>'textarea','value'=>'Our product and our people are built around your needs, with responsive support whenever you need it.'],            ['page'=>$p,'key'=>'cta_heading','label'=>'CTA heading','group'=>'Call To Action','type'=>'text','value'=>'Have Questions? Download Our App'],
