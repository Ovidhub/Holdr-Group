...
class PageContentSeeder extends Seeder
{
    ...
    private function home(): array
    {
        ...
        return [
            ...
            ['page'=>$p,'key'=>'feature_cards_title','label'=>'Feature: cards title','group'=>'Features','type'=>'text','value'=>'Set Up & Spend From Your Cards in a Minute'],            ['page'=>$p,'key'=>'feature_secure_title','label'=>'Feature: security title','group'=>'Features','type'=>'text','value'=>'Innovative, Secure and Truly Digital'],
            ...
            ['page'=>$p,'key'=>'platform_heading','label'=>'Platform heading','group'=>'Platform','type'=>'text','value'=>'Your One-Stop Digital Banking Platform'],            ['page'=>$p,'key'=>'stats_heading','label'=>'Stats heading','group'=>'Stats','type'=>'text','value'=>'Trusted by Millions Around the World'],
    ...
    private function about(): array
    {
        $p = 'about';
        return [
            ['page'=>$p,'key'=>'header_title','label'=>'Header title','group'=>'Header','type'=>'text','value'=>'About Mortil Holders'],            ['page'=>$p,'key'=>'who_heading','label'=>'Who-we-are heading','group'=>'Who We Are','type'=>'text','value'=>'Used by 100K+ Businesses of Every Shape & Size'],            ['page'=>$p,'key'=>'story_heading','label'=>'Story heading','group'=>'Our Story','type'=>'text','value'=>'Digital Banking, Reinvented'],
            ...
            ['page'=>$p,'key'=>'customers_heading','label'=>'Customers heading','group'=>'Customers','type'=>'text','value'=>'We Always Aim to Exceed Your Expectations'],            ['page'=>$p,'key'=>'cta_heading','label'=>'CTA heading','group'=>'Call To Action','type'=>'text','value'=>'Have Questions? Download Our App'],
    ...
    private function contact(): array
    {
        $p = 'contact';
        return [
            ['page'=>$p,'key'=>'header_title','label'=>'Header title','group'=>'Header','type'=>'text','value'=>'Contact Us'],            ['page'=>$p,'key'=>'location_label','label'=>'Location label','group'=>'Details','type'=>'text','value'=>'Our Location'],
